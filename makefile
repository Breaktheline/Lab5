CXX = g++
CXXFLAGS = -pedantic -Wall -Werror -Wno-sign-compare -Wno-long-long -nostdinc++ -lm

lab5: Arch.o Linearizator.o PositionInTree.o Common.o SuffixTree.o SuffixTreeBuilder.o Vertex.o Parser.o Worker.o main.o AVLTree.o
	$(CXX) $(CXXFLAGS) -o lab5 Common.o Arch.o Linearizator.o PositionInTree.o SuffixTree.o SuffixTreeBuilder.o Vertex.o Parser.o AVLTree.o Worker.o main.o
